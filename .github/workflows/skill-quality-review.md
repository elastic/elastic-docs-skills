...
description: |
  ...
  documentation and skill-validator criteria. Posts a PR review with findings.
...
Review skills changed in this PR for quality issues and post a PR review with findings.
...
Post a single review with this structure:
